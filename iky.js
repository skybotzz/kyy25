...
if (!isRegister) return reply(mess.regits) 
		 ...
		 if (args.length < 1) return reply(`Example: ${prefix + command} 18 or ${prefix + command} 18/10 or ${prefix + command} 18/1-10`)
                    urls = `http://api.lolhuman.xyz/api/quran/${args[0]}?apikey=2e472e808f3c857e050bf75c`
		   ...
		   if (args.length == 0) return reply(`Example: ${prefix + command} 18 or ${prefix + command} 18/10`)
                ...
                case 'asmaulhusna':
             ///////////////////////////// //////////////////////////  if (!isRegister) return reply(mess.regits) 
		 get_result = await fetchJson(`http://api.lolhuman.xyz/api/asmaulhusna?apikey=2e472e808f3c857e050bf75c`)
                    get_result = get_result.result
		   ...
		   if (args.length == 0) return reply(`Example: ${prefix + command} Muhammad`)
                    query = args.join(" ")
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/kisahnabi/${query}?apikey=2e472e808f3c857e050bf75c`)
                    get_result = get_result.result
		   ...
		   if (args.length == 0) return reply(`Example: ${prefix + command} Yogyakarta`)
                    daerah = args.join(" ")
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/sholat/${daerah}?apikey=2e472e808f3c857e050bf75c`)
                    get_result = get_result.result
...
//////////////////////////  if (!isRegister) return reply(mess.regits) 
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/xnxxsearch?apikey=2e472e808f3c857e050bf75c&query=${query}`)
                    get_result = get_result.result
                    ini_txt = ""
        ...
        ///////////////////////////// //////////////////////////  if (!isRegister) return reply(mess.regits) 
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/xnxx?apikey=2e472e808f3c857e050bf75c&url=${query}`)
                    get_result = get_result.result
...
`
       ...
       ///////////////////////////// //////////////////////////  if (!isRegister) return reply(mess.regits) 
		   if (args.length == 0) return reply(`Example: ${prefix + command} loli`)
                    query = args.join(" ")
                 reply ('loading......')
                    ini_url = await fetchJson(`http://api.lolhuman.xyz/api/pinterest?apikey=2e472e808f3c857e050bf75c&query=${query}`)
